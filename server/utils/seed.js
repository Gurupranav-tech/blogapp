...
async function getPost() {
  ...
  const text = (
    await ai.generateContent(
      'Write a webdev post in 100 words. Make sure the post is technical and with proper title. Make sure the post is in one paragraph and the post body is in markdown',
    )
  ).response.text();
